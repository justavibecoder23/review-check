...
const REALVIEW_TIKTOK_URL = 'https://www.tiktok.com/@realviewueh?_r=1&_t=ZS-99cPQ7fU25A';
          ...
          <table role="presentation" width="100%" cellspacing="0" cellpadding="0" border="0" bgcolor="#ffffff" style="width:100%;max-width:600px;background:#ffffff;border:1px solid #e4e1da;border-radius:24px;border-collapse:separate;overflow:hidden;">
            ...
            <tr>
              <td style="padding:38px 32px 34px;">
                <p style="margin:0 0 22px;font-size:16px;line-height:1.65;color:#171717;font-weight:400;">Chào ${escapedDisplayName},</p>
            ...
            <tr>
              <td style="padding:26px 32px 30px;background:#faf9f6;border-top:1px solid #e0e0e0;">
                ...
                <table role="presentation" width="100%" cellspacing="0" cellpadding="0" border="0" style="width:100%;border-collapse:collapse;">
                  <tr><td style="padding:0 0 9px;color:#4f4f4a;font-size:14px;line-height:1.55;overflow-wrap:anywhere;word-break:break-word;">🌐 <strong style="color:#171717;">Website:</strong> <a href="${REALVIEW_WEBSITE_URL}" style="color:#a84400;text-decoration:none;">realview.com.vn</a></td></tr>
                  <tr><td style="padding:0 0 9px;color:#4f4f4a;font-size:14px;line-height:1.55;overflow-wrap:anywhere;word-break:break-word;">📧 <strong style="color:#171717;">Email:</strong> <a href="mailto:realviewueh@gmail.com" style="color:#a84400;text-decoration:none;">realviewueh@gmail.com</a></td></tr>
                  <tr><td style="padding:0 0 9px;color:#4f4f4a;font-size:14px;line-height:1.55;overflow-wrap:anywhere;word-break:break-word;">📞 <strong style="color:#171717;">Hotline:</strong> <a href="tel:+84377120633" style="color:#a84400;text-decoration:none;">037 712 0633</a></td></tr>
                  <tr><td style="padding:0 0 9px;color:#4f4f4a;font-size:14px;line-height:1.55;overflow-wrap:anywhere;word-break:break-word;">📘 <strong style="color:#171717;">Facebook:</strong> <a href="${REALVIEW_FACEBOOK_URL}" style="color:#a84400;text-decoration:none;">RealView - Tổng hợp và đánh giá reviews</a></td></tr>
                  <tr><td style="padding:0;color:#4f4f4a;font-size:14px;line-height:1.55;overflow-wrap:anywhere;word-break:break-word;">🎵 <strong style="color:#171717;">TikTok:</strong> <a href="${REALVIEW_TIKTOK_URL.replaceAll('&', '&amp;')}" style="color:#a84400;text-decoration:none;">@realviewueh</a></td></tr>
                </table>
              </td>
            </tr>
          </table>
