...
- `illustrations/undraw-user-feedback.svg`
  ...
  - Giấy phép: `https://undraw.co/license`.
  - Thay đổi trong dự án: đổi màu tím chính thành `#FC781F`, màu tối thành `#161616` và `#4F4F49` để đồng bộ bảng màu RealView.

- Bộ minh họa theo ngữ cảnh dùng trong “Vì sao nên chọn RealView?” và “Tính năng nổi bật”
  - Tác giả: Katerina Limpitsouni / unDraw.
...
- `illustrations/results-review-filter.svg`
  ...
  - Giấy phép/điều khoản: `https://storyset.com/terms`.
  - Sử dụng: minh họa có nhân vật và phễu lọc cho thao tác xem cách RealView lọc review.
  - Thay đổi trong dự án: đổi màu nhấn xanh `#407BFF` thành màu thương hiệu `#FC781F`.

## Icon

- Hệ icon chức năng của website tham chiếu Lucide Icons — bộ SVG mã nguồn mở do cộng đồng thiết kế và duy trì theo một hệ quy chuẩn thống nhất: `https://lucide.dev/`.
- Giấy phép Lucide: ISC — `https://lucide.dev/license`.
- Phạm vi áp dụng gồm quy trình “Cách dùng”, điều khiển chuyển trang review, dấu xác minh người mua, lý do giảm ưu tiên, mũi tên và thao tác mở sản phẩm trên trang kết quả. SVG được đặt trực tiếp trong HTML/JavaScript và điều chỉnh kích thước, màu, độ dày nét theo ngữ cảnh RealView; không dùng hình tạo bởi AI hoặc font icon không rõ nguồn.
- Hai cụm lợi ích và tính năng trên trang chủ không dùng icon SVG thu nhỏ; chúng dùng minh họa theo ngữ cảnh của unDraw.

## Ảnh chụp

- `photos/pexels-monstera-production-9429449.jpg`
  - Tác giả: Monstera Production.
  - Nguồn: `https://www.pexels.com/photo/smiling-black-woman-with-smartphone-9429449/`.
  - Giấy phép: Pexels License — `https://www.pexels.com/license/`.
  - Sử dụng: ảnh người thật mỉm cười và đưa điện thoại lên trong vùng hình ảnh chính của trang chủ.

- `photos/pexels-ivan-s-5429025.jpg`
  - Tác giả: Ivan S.
  - Nguồn: `https://www.pexels.com/photo/happy-friends-looking-at-a-mobile-phone-5429025/`.
  - Giấy phép: Pexels License — `https://www.pexels.com/license/`.
  - Sử dụng: hình ảnh người dùng cùng xem nội dung trên điện thoại trong cụm “Góc nhìn người mua”.

- `photos/pexels-pavel-danilyuk-7190922.jpg`
  - Tác giả: Pavel Danilyuk.
  - Nguồn: `https://www.pexels.com/photo/a-woman-using-a-smartphone-7190922/`.
  - Giấy phép: Pexels License — `https://www.pexels.com/license/`.
  - Sử dụng: hình ảnh mua sắm trực tuyến trên điện thoại và máy tính.

- `photos/pexels-katya-wolf-8733486.jpg`
  - Tác giả: Katya Wolf.
  - Nguồn: `https://www.pexels.com/photo/friends-looking-at-a-cellphone-8733486/`.
  - Giấy phép: Pexels License — `https://www.pexels.com/license/`.
  - Sử dụng: hình ảnh người dùng chia sẻ nội dung trên điện thoại.
